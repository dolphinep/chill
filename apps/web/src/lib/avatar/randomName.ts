...
const ADJECTIVES = [
  'Sleepy', 'Cozy', 'Drowsy', 'Quiet', 'Gentle', 'Mellow', 'Snug', 'Calm',
  'Dreamy', 'Misty', 'Soft', 'Warm', 'Lazy', 'Breezy', 'Sunny', 'Foggy',
  'Frosty', 'Glowing', 'Wandering', 'Curious', 'Humble', 'Cheerful', 'Serene', 'Tranquil',
]

const CREATURES = [
  'Otter', 'Fox', 'Owl', 'Rabbit', 'Deer', 'Hedgehog', 'Panda', 'Raccoon',
  'Sparrow', 'Seal', 'Badger', 'Squirrel', 'Koala', 'Penguin', 'Duckling', 'Fawn',
  'Moth', 'Firefly', 'Turtle', 'Lynx', 'Wren', 'Heron', 'Beaver', 'Mole',
]
