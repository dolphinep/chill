...
const AMBIENCE_OPTIONS: AmbienceOption[] = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="h-5 w-5">
        <path d="M12 2c1 3 2.5 5 4.5 7 2 2 2.5 4.5 1.5 7a7 7 0 0 1-12 0c-1-2.5-.5-5 1.5-7 2-2 3.5-4 4.5-7z" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 14a2.5 2.5 0 0 0-2.5 2.5c0 1.5 1.2 2.5 2.5 2.5s2.5-1 2.5-2.5A2.5 2.5 0 0 0 12 14z" strokeLinecap="round" />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="h-5 w-5">
        <path d="M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.389 5.389 0 0 1-4.4 2.26 5.403 5.403 0 0 1-3.14-9.8c-.44-.06-.9-.1-1.36-.1z" strokeLinecap="round" />
...
export function SoundModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="glass flex w-full max-w-md flex-col gap-4 p-5 text-white shadow-2xl rounded-2xl border border-white/15 max-h-[85vh] overflow-y-auto custom-scrollbar">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-white/10 pb-3">
          <div className="flex items-center gap-2.5">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="h-5 w-5 text-white/90">
        ...
        <div className="flex flex-col gap-3 rounded-xl bg-white/5 p-3.5 border border-white/10">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between text-xs">
              <span className="text-white/90 font-medium">Master Volume</span>
            ...
            <div className="flex items-center gap-3">
              <button
                type="button"
                onClick={() => toggleMute()}
                className="p-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-white/90 transition flex items-center justify-center shrink-0"
                title="Mute / Unmute"
              >
                {audioState.muted ? (
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  command?.({ type: 'setVolume', volume: effectiveMasterVolume({ ...audioState, masterVolume: v }) })
                }}
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between text-xs">
              <span className="text-white/80 font-medium">Lo-Fi Generative Music</span>
              <span className="text-white/60 tabular-nums font-mono">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between text-xs">
              <span className="text-white/80 font-medium">Nature Ambience Sound</span>
              <span className="text-white/60 tabular-nums font-mono">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between text-xs">
              <span className="text-white/80 font-medium">Sound Effects & World (SFX)</span>
              <span className="text-white/60 tabular-nums font-mono">
            ...
            {LOFI_MOODS.map((m) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col p-2.5 rounded-xl transition text-left border ${
                    active
                ...
                >
                  ...
                  <span className="text-[10px] text-white/50 mt-0.5 leading-tight">{m.desc}</span>
                </button>
              )
            })}
          </div>
        ...
        <div className="flex justify-end pt-2 border-t border-white/10">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 text-xs font-medium rounded-xl bg-white/15 hover:bg-white/25 text-white transition"
          >
            Done
          </button>
        </div>
