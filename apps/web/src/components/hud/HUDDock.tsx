...
export function HUDDock({
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-1.5 left-1/2 z-40 -translate-x-1/2 transition-all duration-300 select-none sm:bottom-2 ${
          isCollapsed
      ...
      >
        <button
          ...
          className="glass flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-medium text-white/80 shadow-2xl backdrop-blur-md transition hover:scale-105 hover:bg-white/15 hover:text-white active:scale-95"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      >
        ...
        <button
          ...
          title="Hide toolbar"
          className="glass group absolute -top-3.5 left-1/2 flex h-4.5 w-10 -translate-x-1/2 items-center justify-center rounded-full border border-white/15 text-white/60 shadow-md backdrop-blur-md transition hover:bg-white/15 hover:text-white active:scale-95"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
